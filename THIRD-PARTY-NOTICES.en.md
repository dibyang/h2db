...
[中文](THIRD-PARTY-NOTICES.md)

This inventory is derived from `h2/build.gradle` and is intended for release review. Re-check it before each release with the resolved dependency graph and published POM files.
