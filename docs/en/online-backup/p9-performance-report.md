...
The prepare P50/P95/P99/max values were 0/1/3/3 ms. The writer completed 622
transactions in the 500 ms baseline window and 529 in the 500 ms recovery
window. Net LDB file growth was 0 bytes.
...
Across 20 prepare/abort cycles, P50/P95/P99/max were 4/8/18/18 ms while 57
DML commits and 17 DDL create/drop cycles completed. The long transaction was
...
This proves the first-rollout workload meets the one-second SLO on the tested
