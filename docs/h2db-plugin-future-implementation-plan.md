...
| --- | --- | --- | --- | --- | --- |
| `T-PLUGIN-R1-SQL-METADATA-01` | JUnit 或 `TestBase` | `h2/src/test-plugin` 或 `h2/src/test/org/h2/test/db` | `.\gradlew.bat test` | R1 | [ ] |
| `T-PLUGIN-R1-CAPABILITY-ROWS-01` | JUnit | `h2/src/test-plugin` | `.\gradlew.bat runPluginArchitectureCheck` | R1 | [ ] |
| `T-PLUGIN-R2-STORAGE-ID-PERSIST-01` | JUnit + Gradle 专项 | `h2/src/test-plugin`，必要时新增专项入口 | `.\gradlew.bat test`，必要时 `.\gradlew.bat runMvStoreRecoveryCheck` | R2 | [ ] |
| `T-PLUGIN-R2-UPGRADE-ROLLBACK-01` | `TestBase` 或 Gradle 专项 | `h2/src/test/org/h2/test/store` | `.\gradlew.bat runMvStoreRecoveryCheck` | R2 | [ ] |
| `T-PLUGIN-R3-SECOND-STORAGE-CRUD-01` | JUnit | `h2/src/test-plugin` | `.\gradlew.bat test` | R3 | [ ] |
| `T-PLUGIN-R3-COMPAT-SQL-01` | `TestBase` | `h2/src/test/org/h2/test/db` | 登记后确认入口 | R3 | [ ] |
| `T-PLUGIN-R4-READONLY-DEGRADE-01` | JUnit | `h2/src/test-plugin` | `.\gradlew.bat test` | R4 | [ ] |
| `T-PLUGIN-R4-NO-WRITE-ON-DEGRADE-01` | JUnit 或 `TestBase` | `h2/src/test-plugin` 或 `h2/src/test/org/h2/test/db` | `.\gradlew.bat test` | R4 | [ ] |
| `T-PLUGIN-R5-S1-COMPACT-BRIDGE-01` | Gradle 专项 | `h2/src/test/org/h2/test/store` | `.\gradlew.bat runMvStoreSpaceReclamationCheck` | R5 | [ ] |
| `T-PLUGIN-R5-S2-ONLINE-VACUUM-01` | JUnit + Gradle 专项 | `h2/src/test-plugin`，`h2/src/test/org/h2/test/store` | `.\gradlew.bat test`，`.\gradlew.bat runMvStoreSpaceReclamationCheck` | R5 | [ ] |
| `T-PLUGIN-R6-CLASSLOADER-ISOLATION-01` | JUnit | `h2/src/test-plugin` | `.\gradlew.bat test` | R6 | [ ] |
| `T-PLUGIN-R6-RESOURCE-CLOSE-01` | JUnit | `h2/src/test-plugin` | `.\gradlew.bat test` | R6 | [ ] |
| `T-PLUGIN-R7-VERSION-RANGE-SEMANTICS-01` | JUnit | `h2/src/test-plugin` | `.\gradlew.bat test` | R7 | [ ] |
| `T-PLUGIN-R7-DEPENDENCY-ORDER-01` | JUnit | `h2/src/test-plugin` | `.\gradlew.bat test` | R7 | [ ] |
| `T-PLUGIN-R8-SERVICE-RESOURCE-01` | JUnit | `h2/src/test-plugin` + test resources | `.\gradlew.bat test` | R8 | [ ] |
| `T-PLUGIN-R8-SAMPLE-PLUGIN-01` | JUnit 或样例编译入口 | 待定样例目录 | 登记后确认入口 | R8 | [ ] |
| `T-PLUGIN-R9-HELP-RESOURCE-01` | 文档/资源检查 | `h2/src/main/org/h2/res/help.csv` 等 | `.\gradlew.bat compileJava`，必要时帮助资源检查 | R9 | [ ] |
| `T-PLUGIN-R9-DEVELOPER-GUIDE-01` | 文档检查 | `docs/` | 文档评审 | R9 | [ ] |
...
R1-R9 是在 F0-F9 骨架之上的真实产品化和工程化阶段。进入每个阶段前，先把本节拆成该阶段的详细实施小节或独立文档；阶段完成后更新状态、测试资产和本地 commit。
