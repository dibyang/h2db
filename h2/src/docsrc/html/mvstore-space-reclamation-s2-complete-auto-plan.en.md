...
| --- | --- | --- | --- | --- |
| S2.9 | Planned | Hold release and reset target | Mark release as held; switch target to complete automatic organization; remove release-ready framing | docs + `runMvStoreReclamationJUnitCheck` |
